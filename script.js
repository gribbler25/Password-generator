...
function writePassword() {
  function generatePassword() {
    ...
    if (passLength < 8 || passLength > 128) {
      ...
      window.alert("You will first choose at least one of the following: SPECIAL CHARACTERS, NUMBERS, LOWER CASE and UPPER CASE letters");
      ...
      if (isSpChars) {
        ...
        window.confirm("Are you sure you don't want to include special characters?");
        if (window.confirm) {
